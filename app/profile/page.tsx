...
// Переписал функцию по классике, чтобы Vercel не ругался на парсинг
function getShortId(id) {
    if (!id) return '#FL-...';
    return '#FL-' + id.slice(0, 4).toUpperCase();
}
        ...
        const init = async () => {
            ...
            if (profiles) {
                ...
                if (me) {
                    ...
                    localStorage.setItem(`follows_${user.id}`, JSON.stringify(me.following || []))
                }
            }
